    ...
    <a-space direction="vertical" size="large" style="width: 100%">
      ...
      <a-space direction="vertical" style="width: 100%">
        <a-table size="middle" bordered :data-source="dataSource" align="center" :loading="tableLoading" :pagination="false">
          ...
          <a-table-column title="加油总量（L)" align="center" :ellipsis="true" />
          <a-table-column title="单价(元）" align="center" :ellipsis="true" />
          <a-table-column title="总金额(元）" align="center" :ellipsis="true" />
          <a-table-column title="总行驶里程（km）" align="center" :ellipsis="true" />
          <a-table-column title="加油次数" align="center" :ellipsis="true" />
        </a-table>
