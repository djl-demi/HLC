<template>
  <div id="AnalysisOfLaunchFrequency">
    <a-space direction="vertical" size="large" style="width: 100%">
      <div class="oh">
        <a-space class="fl search-line-top " size="middle">
          <div>
            <span>车牌：</span>
          ...
          <div>
            <span>加油站：</span>
            <div class="dib"><a-input v-model="street" class="w200" show-search placeholder="请输入加油站" allowClear /></div>
          </div>
          <div>
            <span>操作人：</span>
            <div class="dib"><a-input v-model="street" class="w200" show-search placeholder="请输入操作人" allowClear /></div>
          </div>
          <div>
            <span>时间：</span>
        ...
        <a-space class="fl search-line" size="middle">
          <a-button type="primary" :loading="tableLoading" @click="popLayer('oilCard')">加油卡</a-button>
          <a-button type="primary" :loading="tableLoading" @click="popLayer('oilType')">油型</a-button>
        </a-space>
      </div>
      <a-space direction="vertical" style="width: 100%">
        <a-table size="middle" bordered :data-source="dataSource" align="center" :loading="tableLoading" :pagination="false">
          <a-table-column title="编号" key="launchTime" data-index="launchTime" align="center" :ellipsis="true" />
          <a-table-column title="车牌" align="center" :ellipsis="true" />
          <a-table-column title="车辆类型" align="center" :ellipsis="true" />
          <a-table-column title="油型" align="center" :ellipsis="true" />
          <a-table-column title="里程数" align="center" :ellipsis="true" />
          <a-table-column title="司机" align="center" :ellipsis="true" />
          <a-table-column title="电子签名" align="center" :ellipsis="true" />
          <a-table-column title="加油量(L)" align="center" :ellipsis="true" />
          <a-table-column title="单价(元)" align="center" :ellipsis="true" />
          <a-table-column title="金额(元)" align="center" :ellipsis="true" />
          <a-table-column title="加油站" align="center" :ellipsis="true" />
          <a-table-column title="加油时间" align="center" :ellipsis="true" />
          <a-table-column title="备注" align="center" :ellipsis="true" />
...
export default {
  ...
  methods: {
    popLayer(type) {
      this.$router.push({ path: "/statistics/" + type })
    },
    // 日期筛选
    timeChange(e, v) {
      this.startTime = v[0]
