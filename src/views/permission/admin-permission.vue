<template>
  <div id="BackgroundPermission">
    <TyPermission
      ...
      :PermissionAdd="BackgroundPermissionAdd"
      :PermissionEdit="BackgroundPermissionEdit"
      :PermissionDel="BackgroundPermissionDel"
      :edit="true"
...
export default {
  ...
  created() {
    this.BackgroundPermissionSearch && this.getTableList()
  },
  computed: {
    BackgroundPermissionSearch() {
      return this.$com.getPermission(this.$route.matched, "BackgroundPermissionSearch")
    },
    BackgroundPermissionAdd() {
      return this.$com.getPermission(this.$route.matched, "BackgroundPermissionAdd")
    },
    BackgroundPermissionEdit() {
      return this.$com.getPermission(this.$route.matched, "BackgroundPermissionEdit")
    },
    BackgroundPermissionDel() {
      return this.$com.getPermission(this.$route.matched, "BackgroundPermissionDel")
    }
  },
  methods: {
    // 获取数据
